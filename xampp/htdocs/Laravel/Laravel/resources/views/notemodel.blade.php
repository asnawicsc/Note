...
<link rel="stylesheet"  href="{{ url('css/Laravel-style.css') }}">
<script  href="{{ url('js/jquery-3.5.1.min.js') }}"></script>
        <title>MYNIC</title>
    ...
    <body>
     ...
     <button class="btn btn-primary">dasdsadad</button>
     <script  href="{{ url('js/popper.min.js') }}"></script>
...
<body>
   <div class="wrapper">
         ...
         <div class="aside-inner">
            <nav class="sidebar" data-sidebar-anyclick-close="">
               ...
               <ul class="nav">
                     ...
                     <div class="collapse" id="user-block">
                        <div class="item user-block">
                           ...
                           <div class="user-block-info">
                              <span class="user-block-name">Hello, Asnawi</span>
                  ...
                  <li class=" ">
                     <a href="/note" title="Note">
                        <div class="pull-right label label-success">30</div>
                        <em class="icon-grid"></em>
                        <span data-localize="sidebar.nav.WIDGETS">Notes</span>
                     </a>
                  </li>
				  ...
				  <tbody>
				   @foreach($notes as $notedata)
				    <tr>
				      <th>{{ $notedata->id}}</th>
				      <td>{{ $notedata->name}}</td>
				       <td>{{ $notedata->description}}</td>
				      <td>{{ $notedata->created_at}}</td>
				      <td>{{ $notedata->updated_at}}</td>
				      <td><a href="{{action('NoteController@edit', $notedata['id']) }}" class="btn btn-success">EDIT</a>
				      	 <form action="{{ action('NoteController@destroy',$notedata['id']) }}" method="POST" >
         	{{ csrf_field()}}
      ...
      <!-- Page footer-->
      <footer>
         <span>&copy; 2020 - Laravel Note Project</span>
      </footer>
   </div>
   <!-- =============== VENDOR SCRIPTS ===============-->
   <!-- MODERNIZR-->
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		  ...
		  <div class="form-group">
		    ...
		    <input  type="text" placeholder="Description" required="required" name="description" class="form-control" >
		  </div>
      </div>
